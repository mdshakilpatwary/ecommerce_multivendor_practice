							...
							<div class="card-body">
                                ...
                                <form action="{{route('category.save')}}" method="POST" enctype="multipart/form-data">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="cat_name" name="cat_name" placeholder="Enter Your Category Name" value="">
											@error('cat_name')
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<button type="submit" name="add_cat" class="btn btn-info px-5">Add</button>
										</div>
									</div>
                                </form>    
							</div>
