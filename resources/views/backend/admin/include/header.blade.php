        ...
        <nav class="navbar navbar-expand">
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{empty($userinfo->image)? asset('uploads/backend/adminUploads/avater.jpg'): asset('uploads/admin/adminUploads/'.$userinfo->image)}}" class="user-img" alt="user avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{$userinfo->name}}</p>
                        <p class="designattion mb-0">{{$userinfo->email}}</p>
                    </div>
                </a>
